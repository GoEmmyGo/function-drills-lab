...
console.log(printName(`Emmaline`))
...
let nameGreeting = nameCheck(`Emmaline`)
...
emailCheck(` emmalinerose@gmail.com `)
////////////////// PROBLEM 19 ////////////////////
/*
  Write a function, naming it whatever you believe to be appropriate, that 
  buys as many chocolate frogs as possible with a certain amount of gold. 
  Each chocolate frog costs 3 gold. Your function should take in a single parameter, 
  which is the amount of gold you are willing to spend. Your function should return a total 
...
const frogCounter = (gold) => Math.floor(gold / 3) 

let totalFrogs = frogCounter(10)

console.log(totalFrogs)


//CODE HERE (partner's code)
function frogBuyer(goldAmount){
  Number(goldAmount);
  let numberOfFrogs = 0;
  while(goldAmount > 0){
    console.log(`while`)
...
let numberOfFrogs = frogBuyer(100);
*/
...
/*
  ...
  You would just be able to purchase 1 product. Re-write the function you used in 
  the previous problem (give it the same name, just add a 2 to the end of it) that fixes this bug. 
  Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/

//CODE HERE
/*
function frogBuyer2(goldAmount){
  goldAmount -= (goldAmount % 3)
  goldAmount = goldAmount - (goldAmount % 3)
  return goldAmount /= 3
}
...
const buyFrogs = goldAmount => goldAmount / 3 | 0;
...
let arrayIsAscending = silly(sampleArray)
